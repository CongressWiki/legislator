...
const SvgBallotVote = (properties: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      height="1em"
      width="1em"
    ...
    >
      ...
      <path d="M169.5 219.1l30.5-30.5-33.9-33.9c-4.6 3.6-9.6 6.6-15 8.9-2.4 1.1-5.1 1.6-7.7 1.6-10.8 0-19.5-8.7-19.5-19.5 0-7.8 4.6-14.8 11.8-17.9l2.4-1.2-12.7-12.6-74.6 74.6 30.5 30.5H21.9v11.3h225.5v-11.3h-77.9z" />
    </svg>
  );
};

export default SvgBallotVote;
