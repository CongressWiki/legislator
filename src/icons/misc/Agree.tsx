...
const SvgAgree = (properties: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      viewBox="0 0 100 100"
    ...
    >
      ...
      <path d="M5268.4 2410.3c-.6 0-1 .4-1 1s.4 1 1 1h4.3c.6 0 1-.4 1-1s-.4-1-1-1h-4.3zm4.3 3.4h-4.3c-.6 0-1 .4-1 1s.4 1 1 1h4.3c.6 0 1-.4 1-1s-.4-1-1-1zm0 3.3h-4.3c-.6 0-1 .4-1 1s.4 1 1 1h4.3c.6 0 1-.4 1-1 0-.5-.4-1-1-1zM23.3 66.4c-2.1 1.2-4.5 2-7.1 2s-5-.7-7.1-2c-3 1.4-5.2 4.2-5.7 7.6l-.9 7.7c-.1 1 .5 2 1.5 2.2 3.8.8 7.9 1.2 12.2 1.2s8.4-.4 12.2-1.2c1-.2 1.6-1.2 1.5-2.2L29 74c-.4-3.4-2.6-6.2-5.7-7.6z" />
