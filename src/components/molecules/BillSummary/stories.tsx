...
import BillSummary, {
  BillSummaryProps as BillSummaryProperties,
} from './index';

export default {
  title: 'Components/molecules/BillSummary',
...
const Template: Story<BillSummaryProperties> = (arguments_) => (
  <TestBox>
    <BoxWrapper>
      <h2>Original bill summary</h2>
      <Paper>
        <BillParagraph>{arguments_.summary}</BillParagraph>
      </Paper>
    </BoxWrapper>
    <BoxWrapper>
      <h2>This component</h2>
      <Paper>
        <BillSummary {...arguments_} />
      </Paper>
    </BoxWrapper>
  </TestBox>
);
