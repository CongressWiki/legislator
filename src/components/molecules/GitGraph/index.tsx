...
interface GitgraphState {
  ...
  commitYWithOffsets: Record<number, number>;
...
class Gitgraph extends React.Component<GitgraphProps, GitgraphState> {
  ...
  private readonly gitgraph: GitgraphCore<ReactSvgElement>;
  private readonly $graph = React.createRef<SVGSVGElement>();
  private readonly $commits = React.createRef<SVGGElement>();
