...
import BillText, { BillTextProps as BillTextProperties } from './index';

export default {
  title: 'Components/molecules/BillText',
  component: BillText,
} as Meta;
...
const Template: Story<BillTextProperties> = (arguments_) => (
  <TestBox>
    <BoxWrapper>
      <h2>Original bill text</h2>
      <Paper>
        <BillParagraph>{arguments_.billText}</BillParagraph>
      </Paper>
    </BoxWrapper>
    <BoxWrapper>
...
// Export const ListBill = Template.bind({});
// ListBill.args = {
//   billText: "",
// };
