...
import Bill, { BillProps as BillProperties } from './index';

export default {
  title: 'Components/organisms/BillV1',
  component: Bill,
} as Meta;

const Template: Story<BillProperties> = (arguments_) => (
  <Bill {...arguments_} />
);
...
withBillSummary.args = {
  ...
  actions: [
    ...
    {
      text: 'Subcommittee on Public Lands and Environmental Regulation Discharged.',
      type: 'action',
      acted_at: '2013-07-31',
      committees: ['HSII'],
      references: [],
    ...
    {
      text: 'Reported (Amended) by the Committee on Natural Resources. H. Rept. 113-297.',
      type: 'action',
      acted_at: '2013-12-16',
      committees: ['HSII'],
      references: [],
...
withBillText.args = {
  ...
  actions: [
    ...
    {
      text: 'Referred to the Committee on Oversight and Reform, and in addition to the Committee on the Judiciary, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.',
      type: 'referral',
      status: 'REFERRED',
      acted_at: '2021-01-21',
      committees: ['HSGO'],
...
WithLongBillSummary.args = {
  ...
  actions: [
    ...
    {
      text: 'Committee on Indian Affairs. Ordered to be reported with an amendment favorably.',
      type: 'calendar',
      status: 'REPORTED',
      acted_at: '2017-05-17',
      committees: ['SLIA'],
    ...
    {
      text: 'Committee on Indian Affairs. Reported by Senator Hoeven with amendments. With written report No. 115-174.',
      type: 'reported',
      acted_at: '2017-10-17',
    ...
    {
      text: 'Placed on Senate Legislative Calendar under General Orders. Calendar No. 248.',
      type: 'calendar',
    ...
    {
      text: 'Referred to the Committee on Natural Resources, and in addition to the Committee on Education and the Workforce, for a period to be subsequently determined by the Speaker, in each case for consideration of such provisions as fall within the jurisdiction of the committee concerned.',
      type: 'referral',
      acted_at: '2018-03-26',
      committees: ['HSII'],
      references: [],
